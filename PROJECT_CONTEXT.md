...
Status: Milestone 0 is closed. On branch `m1_ledger`, Milestone 1 Components 1.1–1.6 are accepted and the initial D/E integration tests pass, but Phase F has reopened five evidence-conformance questions before closure. Optional Milestone 0_a1 remains isolated on `m0_a1_visualizer`.
